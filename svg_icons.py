...
def gerar_svg_parada() -> str:
    """Gera SVG de placa de parada com ícone de ônibus e retorna data-URI codificado."""
    svg = (
...
def cache_or_generate_svg(color: str, bearing: Optional[Union[float, int]]) -> Tuple[str, List[int], List[int]]:
...
def make_vehicle_icon(bearing: Optional[Union[float, int]], color: str = "#1a6faf") -> Tuple[str, List[int], List[int]]:
